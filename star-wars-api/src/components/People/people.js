    ...
    <>
      {status === "success" && ( // Display the heading only when the data is successfully loaded
        <div className='heading'>
          <h3 className='headingtext'>People</h3>
              ...
              <div className="image"></div>
                <div className='greypart'>
                    <div className="divsection">
                        <img src={userIcon} alt="#" className='filmReel'></img>
            ...
            <div className="table-view">
              <table>
                ...
                <tbody>
                  ...
                  {data.results.map(people => (
                    <tr key={people.name}>
                      <td className='firstCol'><img src={userIcon} alt={people.name}></img>{people.name}</td>
